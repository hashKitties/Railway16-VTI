...
public class Question2 {
    public static void main(String[] args) {
        ...
        System.out.printf("Exam 1 duoc tao vao %tY/%tm/%td %tHh:%tMp:%tSs",exam1.createdDate,exam1.createdDate,exam1.createdDate,exam1.createdDate,exam1.createdDate,exam1.createdDate);
